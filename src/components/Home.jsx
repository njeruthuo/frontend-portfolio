    ...
    <section id="home" className="home-height flex items-start sm:items-center">
      <div className="w-[90%] mx-auto flex sm:flex-row flex-col-reverse place-items-center">
        <div className="sm:w-1/2 w-full">
          <h1 className="sm:text-5xl text-xl text-center libertinus-mono-regular sm:text-left mb-4">
            Hello, I'm Julius, <br />
            <span className="block libertinus-mono-regular text-gradient pt-2">
              {" "}
              a Full stack Developer
            </span>
          </h1>
          <p className="text-white text-center text-base/6 sm:text-left pr-6 montserrat-500">
