const Resume = () => {
  return (
    <section id="resume" className="min-h-screen bg-slate-800  scroll-pt-10 pb-5">
      <div className="w-[90%] mx-auto pt-10">
        ...
        <div id="about me" className="flex gap-4 mt-8 flex-col sm:flex-row">
          <div className="w-full sm:w-1/2">
            <h2 className="text-center font-extrabold">Education:</h2>
          ...
          <div className="w-full sm:w-1/2">
            <h2 className="text-center font-bold">Work Experience:</h2>
